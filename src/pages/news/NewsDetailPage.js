...
function NewsDetailPage() {
    ...
    const newsItem = {
        image: `${process.env.PUBLIC_URL}/images/hero-image-small.jpg`,
                            ...
                            <Card elevation={1} raised={true} variant="elevation">
                                ...
                                <CardContent>
                                    <p><span className="font-size-small font-weight-bold">{author}</span> <span
                                        ...
                                        className="font-size-small font-weight-bold">{new Date(dateCreated).toDateString()}</span>
                                    </p>
                                    <p className="font-weight-bold font-size-large uppercase grey-text">{title}</p>
                                    <p className="font-size-medium grey-text">{summary}</p>

                                    <p className="font-size-small grey-text">{detail}</p>
